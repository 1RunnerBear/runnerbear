...
(function(){
  ...
  function moreHtml(){
    ...
    return `<div id="rb107More" class="rb107-surface rb116-more"><div class="rb107-shell"><header class="rb107-section-head"><div><span class="rb107-overline">Innstillinger og sporbarhet</span><h1>Mer</h1><p>Alt som styrer coachen, samlet uten dashboardstøy.</p></div></header><section class="rb116-coach-identity"><span class="rb116-coach-mark">${icon('coach')}</span><div><span>Din Bakken-coach</span><h2>Raskere. Skadefri. Med kontroll.</h2><p><i class="${mode==='autopilot'?'active':''}"></i>${mode==='autopilot'?'Autopilot aktiv':'Manuell kontroll'}</p></div></section>
      ...
      <section class="rb116-settings-group"><h2>Sporbarhet</h2>
        ...
        <details class="rb116-setting"><summary><span class="rb116-setting-icon">${icon('info')}</span><div><b>Om RunnerBear</b><small>Versjon 10.19 · privat coachmiljø</small></div><strong>›</strong></summary><div class="rb116-setting-body rb116-about"><b>RunnerBear 10.19</b><p>Garmin registrerer. RunnerBear tolker, planlegger og veileder etter den Bakken-inspirerte kjernen.</p></div></details>
      </section>
    </div></div>`;
  }
  ...
  function ensureCoachStyles(){
    ['runnerbear-v1013-coach-ui.css','runnerbear-v1014-premium-polish.css','runnerbear-v1016-goals-more.css','runnerbear-v1017-ux.css','runnerbear-v1018-plan-preferences.css','runnerbear-v1019-design-system.css'].forEach(name=>{const link=qs(`link[href*="${name}"]`);if(link)document.head.appendChild(link)});
  }
  ...
  window.RunnerBearCoachOS={version:'10.19',effectiveSchedule,planFor,forecast,thresholdEvidence,matches:allMatches,analysisFor,sessionAssessment,workoutStructure,garminQueue,tredictPlanQueue,goalState,trainingPreferences,render:renderAll,moveWorkout,toggleLock,setChoice,adapt};
