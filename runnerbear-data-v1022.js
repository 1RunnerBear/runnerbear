/* RunnerBear 10.22 lazy Cloud/data runtime · generated by scripts/build-v1022.mjs */
...
/* RunnerBear v10.22 · non-blocking Cloud state and lazy data client */
(function(){
  'use strict';
  const BUILD='10.22';
  ...
  function applyTredict(cache,{merge=false}={}){
    ...
    const normalized={
      ...
      source:'runnerbear-cloud-v10.22'
    };
