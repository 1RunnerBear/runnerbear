...
`/health` must report `cloudBuild: "10.28.1"`, `schemaVersion: 2`, `coachLoop: true`, `historyIntegrity: true`, a D1 binding, static assets and healthy Tredict RPC v10.26.0.
