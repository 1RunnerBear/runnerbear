...
`/health` must report `cloudBuild: "10.31.2"`, `schemaVersion: 2`, `coachLoop: true`, `historyIntegrity: true`, a D1 binding, static assets and healthy Tredict RPC v10.26.0 or v10.31.1.
