...
test('actual production-flag UI shows correction provenance, original total and a reversible form',()=>{
 ...
 const goal=api.goalPremiumSummaryHtml({targetSeconds:4980});assert.match(goal,/Dette har utviklet seg/);assert.match(goal,/1:23:00/);assert.doesNotMatch(goal,/Målkorridor|Innen rekkevidde/);
