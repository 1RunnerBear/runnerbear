/* RunnerBear 12.3.0 lazy Cloud/data runtime · generated by scripts/build-v11.mjs */
...
(function(){
  'use strict';
  const BUILD=window.RunnerBearRelease?.build||'12.3.0',CACHE='runnerbear_coach_loop_snapshot_v1',SHADOW_COUNT='runnerbear_coach_loop_shadow_success_v1';
  ...
  window.RunnerBearCloudV11={build:BUILD,start,refresh,refreshSync,retrySync,verifySyncRepair,reconfigure,resolveDecision,applySafeAuto,applyRealignment,undoPlan,submitFeedback,submitWorkoutResponse,submitCheckIn,shadowCompare,snapshot:()=>snapshot,decision:()=>snapshot?.coachDecision||null,oneDecision:()=>snapshot?.oneDecision||null,toLegacyDecision,proposalFor};
