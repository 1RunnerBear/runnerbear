/* RunnerBear 12.4.0 lazy Cloud/data runtime · generated by scripts/build-v11.mjs */
...
(function(){
  ...
  window.RunnerBearCloudV11={build:BUILD,start,refresh,refreshSync,retrySync,verifySyncRepair,reconfigure,resolveDecision,applySafeAuto,applyRealignment,undoPlan,submitFeedback,submitPaceCorrection,submitWorkoutResponse,submitCheckIn,shadowCompare,snapshot:()=>snapshot,decision:()=>snapshot?.coachDecision||null,oneDecision:()=>snapshot?.oneDecision||null,toLegacyDecision,proposalFor};
