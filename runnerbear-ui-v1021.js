/* RunnerBear v10.21 · canonical, targeted coaching UI within locked Design Direction 1.0
...
(function(){
  ...
  function trackEvent(name,detail={}){
    const payload={event:name,runnerbearVersion:'10.21',...detail};
  ...
  function decorateBrand(){
    ...
    brand.innerHTML=`<div class="rb"><img src="runnerbear-brand-mark-flat.svg?v=1021" alt=""></div><div><b>RunnerBear</b><span>Bakken-coach</span></div>`;
  }
  ...
  function init(){
    ...
    if(!engine()||!clarityModel()){
      console.error(JSON.stringify({event:'runnerbear_fatal_init',build:'10.21',reason:'canonical core unavailable'}));
    ...
    migrateDocumentedThreshold();migrateTrainingPreferences();runAutopilot();decorateNav();decorateBrand();renderToday();
  ...
  window.RunnerBearCoachOS={version:'10.21',effectiveSchedule,planFor,forecast,thresholdEvidence,matches:allMatches,analysisFor,sessionAssessment,workoutStructure,garminQueue,tredictPlanQueue,goalState,trainingPreferences,intensityProfile,coachBasis,heroBank:HERO_BANK,render:renderAll,renderView,renderToday,renderPlan,renderGoals,renderMore,switchView,metrics:runtimeStats,moveWorkout,toggleLock,setChoice,adapt};
