/* RunnerBear v10.21 · non-blocking Cloud state and lazy data client */
(function(){
  'use strict';
  const BUILD='10.21';
  ...
  function applyTredict(cache,{merge=false}={}){
    ...
    const normalized={
      ...
      source:'runnerbear-cloud-v10.21'
    };
  ...
  function applyBootstrap(data,{merge=false,view=''}={}){
    ...
    installBridgeAdapter();refreshUi(view);
  ...
  window.RunnerBearCloud={build:BUILD,origin:CLOUD_ORIGIN,bootstrap:bootstrapHome,bootstrapHome,bootstrapFull,loadView:bootstrapFull,cloudSync,uploadLocal,previewOutbound,publishOutbound,outboundStatus,verifyOutbound,cachedOutbound};
