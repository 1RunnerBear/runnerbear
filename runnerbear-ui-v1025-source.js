/* RunnerBear v10.25.1 · coach-first adaptive planning within locked Design Direction 1.0
...
(function(){
  ...
  function trackEvent(name,detail={}){
    const payload={event:name,runnerbearVersion:'10.25.1',...detail};
  ...
  function init(){
    ...
    if(!engine()||!clarityModel()||!planIntegrity()||!adaptivePlan()){
      console.error(JSON.stringify({event:'runnerbear_fatal_init',build:'10.25.1',reason:'canonical core unavailable'}));
