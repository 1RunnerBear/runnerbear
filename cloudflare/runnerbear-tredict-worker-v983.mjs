...
export default {
  async fetch(request,env,ctx){
    ...
    if(url.pathname!=='/api/migrate-local')return base.fetch(request,env,ctx);
    ...
    if(request.method!=='POST')return json({ok:false,error:'METHOD_NOT_ALLOWED'},405,origin,allowed);
