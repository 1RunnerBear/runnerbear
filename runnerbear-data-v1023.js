/* RunnerBear 10.23 lazy Cloud/data runtime · generated by scripts/build-v1023.mjs */
...
/* canonical source: runnerbear-cloud-v1021.js */
/* RunnerBear v10.23 · non-blocking Cloud state and lazy data client */
(function(){
  'use strict';
  const BUILD='10.23';
  ...
  function applyTredict(cache,{merge=false}={}){
    ...
    const normalized={
      ...
      source:'runnerbear-cloud-v10.23'
    };
  ...
  function applyBootstrap(data,{merge=false,view=''}={}){
    ...
    try{window.RunnerBearCoachOS?.garminSync?.init?.()}catch{}
